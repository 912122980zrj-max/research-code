...
- `validation_direction.csv` — per-gene direction replication
...
- `candidate_genes_tiered.csv` — merged-path candidates (7, all tier C).
- `evaluable_targets_CLEAN.csv` — orthology-evaluable target list used
  by both paths.
