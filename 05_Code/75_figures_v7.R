...
ggsave(file.path(FIG3, "permutation_background_v7.pdf"), p_perm,
...
p_heat <- ggplot(heat, aes(gene, path, fill = present)) +
  ...
  labs(x = NULL, y = NULL,
       title = "Candidate sets across preprocessing/cohort paths (v7)")
ggsave(file.path(FIG3, "sensitivity_heatmap_v7.pdf"), p_heat,
       width = 8, height = 3.5)
...
ggsave(file.path(FIG4, "GO_BP_bubble_v7.pdf"), p_go,
